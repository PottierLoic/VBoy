...
fn flag_to_u8(reg FlagsRegister) u8 {
  return u8(reg.zero) << zero_flag_byte_position | u8(reg.subtract) << subtract_flag_byte_position | u8(reg.half_carry) << half_carry_flag_byte_position | u8(reg.carry) << carry_flag_byte_position
}
